...
SECTION_KEYS = ["testigos", "consanguinidad", "general", "adn", "migration", "family_completion"]
SECTION_LABELS = [t("section_testigos"), t("section_consanguinidad"), t("section_general"), t("section_adn"), t("section_migration"), t("section_family_completion")]
...
if active_section == "testigos":
    ...
    from modules.family_completion import render_sidebar, render_page
